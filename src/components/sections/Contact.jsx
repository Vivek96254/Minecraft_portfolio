...
import { SOCIAL_LINKS, GITHUB_USERNAME } from '../../utils/constants';
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (!FORMSPREE_ENDPOINT) {
        throw new Error(
          'Contact form is not configured. Please email me directly at ' + SOCIAL_LINKS.email
        );
      }
                ...
                <li>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="text-xs text-pixel-text-light/50 dark:text-pixel-text-dark/50 truncate max-w-[140px]">
                        {SOCIAL_LINKS.email}
                      </div>
                    </div>
                  </motion.a>
