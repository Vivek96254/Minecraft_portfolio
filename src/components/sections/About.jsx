...
const stats = [
  { label: 'Backend Focus', detail: 'Node.js · Go · PostgreSQL' },
  { label: 'Real-time Systems', detail: 'WebSockets · Redis · Events' },
        ...
        >
          <div className="space-y-5">
            <p className="text-base md:text-lg leading-relaxed text-pixel-text-light/85 dark:text-pixel-text-dark/85">
              I'm <span className="text-pixel-accent font-semibold">Vivek</span>, a backend-focused software engineer who gets obsessive about system correctness, low-latency design, and clean API contracts.
            </p>
